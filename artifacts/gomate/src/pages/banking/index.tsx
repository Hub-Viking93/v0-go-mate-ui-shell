    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <Button asChild><Link href="/checklist?tab=post-move">Back to Settling In</Link></Button>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-3xl mx-auto p-6 space-y-6">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" asChild>
              <Link href="/checklist?tab=post-move"><ArrowLeft className="w-5 h-5" /></Link>
            </Button>
            <div>
          ...
          <div className="flex items-center justify-between">
            ...
            {currentStep < 3 ? (
              ...
              <Button asChild>
                <Link href="/checklist?tab=post-move">Done <CheckCircle2 className="w-4 h-4 ml-1" /></Link>
              </Button>
            )}
          </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <Button variant="outline" size="sm" asChild>
        <Link href="/checklist?tab=documents">
