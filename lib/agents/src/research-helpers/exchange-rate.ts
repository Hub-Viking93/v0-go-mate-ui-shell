// =============================================================
// @workspace/agents — exchange-rate (snapshot)
// =============================================================
// Server-side currency exchange rate utility (frankfurter.app).
// Verbatim port of .migration-backup/lib/gomate/exchange-rate.ts
// with the import path adjusted to .js (ESM TS).
// =============================================================
