...
await page.goto('http://localhost:5175/onboarding', { waitUntil: 'networkidle' })
await page.waitForTimeout(3000)
await page.screenshot({ path: '/Users/axel/Downloads/v0-go-mate-ui-shell-main/screenshots/onboarding-current.png', fullPage: true })
